...
PRODUCT_BUILD_PROP_OVERRIDES += \
   ...
   BUILD_FINGERPRINT=verizon/solana_vzw/cdma_solana:4.0.3/5.5.1_84_D3G-55/${BUILD_NUMBER}:user/release-keys \
   PRIVATE_BUILD_DESC="cdma_solana-user 4.0.3 5.5.1_84_D3G-55 "${BUILD_NUMBER}" release-keys" \
   PRODUCT_BRAND=verizon \
   BUILD_UTC_DATE= \
